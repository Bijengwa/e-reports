...
export function RegisterPage({ rows, viewerRole, viewerName }: RegisterPageProps): JSX.Element {
  return (
    ...
    >
      <div
        style={{ display: "flex", flexDirection: "column", height: "100vh", background: "#f5f7f9" }}
      >
        <div
          style={{ padding: "20px 24px", background: "#fff", borderBottom: "1px solid #dbe2e6" }}
        >
              ...
              <tbody>
                {rows.map((row, idx) => (
                  ...
                  >
                    ...
                    >
                      {row.investigation_finding_level_1}
                    </td>
                    <td
                      style={{
                        padding: "9px 8px",
                    ...
                    >
                      {row.investigation_finding_codes}
                    </td>
                    <td
                      style={{
                        padding: "9px 8px",
                    ...
                    >
                      {row.date_assessment_2}
                    </td>
                    <td style={{ padding: "9px 8px", borderBottom: "1px solid #e4e9ec" }}>
                      {row.acknowledgement_feedback}
                    </td>
                  </tr>
                ))}
              </tbody>
